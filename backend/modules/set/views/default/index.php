           ...
           <?php
            $form = ActiveForm::begin([
                ...
                <div class="form-group"><label class="col-lg-4 control-label">菜单名</label>
                    <div class="col-lg-4">
                        <input type="text" name="AgNav[nav_cn]" required class="form-control" id="agnav-nav_cn" placeholder="一级菜单对应模块名称">
                    </div>
                </div>
                <div class="form-group"><label class="col-lg-4 control-label">模块名</label>
                    <div class="col-lg-4">
                        <input type="text" name="AgNav[nav_en]" required="" class="form-control" id="agnav-nav_en" placeholder="请填给模块取个英文名">
                    </div>
                </div>
            ...
            $form = ActiveForm::begin([
                ...
                <div class="form-group"><label class="col-lg-4 control-label">菜单名</label>
                    <div class="col-lg-4">
                        ...
                        <input type="text" name="AgNav[nav_cn]" required="" class="form-control" id="nav_cn" placeholder="一级菜单对应模块名">
                    </div>
                </div>
                <div class="form-group"><label class="col-lg-4 control-label">模块名</label>
                    <div class="col-lg-4">
                        <input type="text" name="AgNav[nav_en]" required="" class="form-control" id="nav_en" placeholder="请填给模块取个英文名">
                    </div>
                </div>
