...
$this->registerMetaTag(['name' => 'keywords', 'content' => '添加文章']);
$this->registerMetaTag(['name' => 'description', 'content' => '添加文章'], 'description');
$this->title= '代理系统-添加文章';
               ...
               <?php
                $form = ActiveForm::begin([
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <?= $form->field($model, 'content')->widget('macle\ueditor\Ueditor',['id'=>'Article[content]'])->label(false); ?>
                        </div>
                    </div>
